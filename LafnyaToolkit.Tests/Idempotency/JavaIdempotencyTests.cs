...
namespace LafnyaToolkit.Tests.Idempotency
{
    ...
    public sealed class JavaIdempotencyTests
    {
        ...
        public void TestIdempotency(bool unused)
        {
            ...
            RunCase("imports", "import java.util.List;\nimport java.util.ArrayList;\nimport com.example.Foo;");
            ...
            RunCase("package and class", "package com.example;public class Foo{}");
            RunCase("long line", "int result=someMethod(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);");
            RunCase("nested class", "public class A{public class B{public class C{}}}");
            RunCase("generics", "public List<Map<String,Integer>> getMap(){return new ArrayList<>();}");
            RunCase("annotation", "@Override public String toString(){return \"Foo\";}");
