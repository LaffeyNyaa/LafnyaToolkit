...
namespace LafnyaToolkit.Tests.Idempotency
{
    ...
    public sealed class GDScriptIdempotencyTests
    {
        ...
        public void TestIdempotency(bool unused)
        {
            ...
            RunCase("class with member", "class_name Foo\nextends Node\nvar x:int=0\nfunc _ready()->void:x=1\n");
            RunCase("if else", "if x>0:\n    a()\nelse:\n    b()\n");
            RunCase("for loop", "for i in range(10):\n    print(i)\n");
            RunCase("while loop", "while x>0:\n    x-=1\n");
            RunCase("func with args", "func add(a:int,b:int)->int:\n    return a+b\n");
            RunCase("signal", "signal pressed\nsignal value_changed(new_value:int)\n");
            RunCase("enum", "enum State{IDLE,RUNNING,STOPPED}\n");
            RunCase("const", "const MAX_SPEED:int=100\nconst PI:float=3.14159\n");
            RunCase("annotation export", "@export var speed:int=10\n@onready var sprite:Sprite=$Sprite\n");
            RunCase("string", "var s:String=\"hello\\nworld\"\n");
            RunCase("raw string", "var s:String=r\"raw\\nstring\"\n");
            RunCase("triple quote", "var s:String=\"\"\"\nmulti\nline\n\"\"\"\n");
            RunCase("dictionary", "var d:Dictionary={\"a\":1,\"b\":2,\"c\":3}\n");
            RunCase("array", "var a:Array=[1,2,3,4,5]\n");
            RunCase("match statement", "match x:\n    1:\n        a()\n    2:\n        b()\n    _:\n        c()\n");
            RunCase("nested func", "func outer()->void:\n    func inner()->void:\n        pass\n");
