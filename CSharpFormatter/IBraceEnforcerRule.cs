...
namespace CSharpFormatter
{
    ...
    /// specific C# control-flow keyword (e.g. <c>if</c>, <c>for</c>,
    /// <c>while</c>, <c>do</c>, <c>foreach</c>, <c>else</c>) when the
    /// keyword is found at a particular position in the source text.
    /// </summary>
