    ...
    internal sealed class OperatorBreakPolicy
    {
        ...
        )
        {
            ...
            while (i < line.Length)
            {
                ...
                else if (bp < 0 && i > startIdx && IsBinaryOpContext(
                    line,
                    i,
                    startIdx
        ...
        /// </summary>
        public bool HasStreamOperators(
            string line,
            int startIdx,
        ...
        /// </summary>
        public List<string> SplitAtStreamOperators(
            string line,
            List<int> positions,
        ...
        /// </summary>
        public bool HasBinaryOperators(
            string line,
            bool[] isCode,
            int startIdx,
            out List<int> positions
        ...
        /// continuation line.
        /// </summary>
        public List<string> SplitAtBinaryOperators(
            string line,
            List<int> positions,
            string fixedContIndent,
            string baseIndent
