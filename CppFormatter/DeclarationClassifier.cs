...
namespace CppFormatter
{
    ...
    /// single-line function declarations, for-loop headers, and
    /// lambda capture lines. Stateless; the shared instance is
    ...
    internal sealed class DeclarationClassifier
    {
        ...
        /// Single-line pattern: "ReturnType FuncName(...) {" — the
        /// content before the closing parenthesis looks like a return
        /// type followed by a function name, not like a parameter
        /// declaration.
        /// </summary>
        public bool IsSingleLineFunctionDeclaration(string scanTrimmed)
        {
            if (scanTrimmed.StartsWith("[") && scanTrimmed.Contains("]("))
            {
                return false;
            }
        ...
        /// </summary>
        public bool IsLambdaLine(string line)
        {
        ...
        /// </summary>
        public bool IsForLoopHeader(string trimmed)
        {
